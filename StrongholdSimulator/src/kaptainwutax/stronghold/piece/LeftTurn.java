...
public class LeftTurn extends Piece {

	public LeftTurn(int pieceType, Random rand, BlockBox boundingBox, Direction facing) {
		super(pieceType);
	...
	public static LeftTurn createPiece(List<Piece> list_1, Random random_1, int int_1, int int_2, int int_3, Direction direction_1, int int_4) {
		BlockBox blockBox_1 = BlockBox.rotated(int_1, int_2, int_3, -1, -1, 0, 5, 5, 5, direction_1);
		return Piece.isHighEnough(blockBox_1) && Piece.getNextIntersectingPiece(list_1, blockBox_1) == null ? new LeftTurn(int_4, random_1, blockBox_1, direction_1) : null;
	}
